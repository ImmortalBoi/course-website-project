                ...
                <ul class="flex flex-col pl-0 mb-0 border rounded border-gray-300 ">
                    @if ($courses)
                        @foreach ($courses as $course)
                            <li class="flex flex-row justify-between relative block py-3 px-6 -mb-px border border-r-0 border-l-0 border-gray-300 no-underline flex justify-between items-start">
                                <p class="font-bold text-center">{{$course->course_name}}</p>
