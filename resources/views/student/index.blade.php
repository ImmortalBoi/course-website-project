                ...
                <div class="p-6 py-5">
                    ...
                    <div class="flex flex-wrap  mb-3 mt-3">
                        <div class="md:w-full pr-4 pl-4"><label class="labels">Phone Number</label><input type="text"
                                class="block shadow appearance-none w-full py-1 px-2 mt-1 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" placeholder="Enter phone number" disabled value=""></div>
                        <div class="md:w-full pr-4 pl-4"><label class="labels">Address</label><input type="text"
                                class="block shadow appearance-none w-full py-1 px-2 mt-1 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" placeholder="enter address" disabled value=""></div>
                        <div class="md:w-full pr-4 pl-4"><label class="labels">Email ID</label><input type="text"
                                class="block shadow appearance-none w-full py-1 px-2 mt-1 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" placeholder="enter email id" disabled value="{{$stn->student_email}}"></div>
