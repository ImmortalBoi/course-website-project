@section('frontTitle','| Availabe Courses')
<x-base-layout>
    <!-- Header Start -->
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-lg justify-content-center mb-0">
                            @php
                                ...
                                $firstPageBool = $courses->onFirstPage();
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link rounded-0" href="{{$courses->previousPageUrl()}}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                    <span class="sr-only">Previous</span>
                                    </a>
                                </li>
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link rounded-0" href="{{$courses->nextPageUrl()}}" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                    <span class="sr-only">Next</span>
                                    </a>
                                </li>
